...
package longRangeWeapon
{
	...
	function projectileData::onExplode(%this, %obj, %pos)
	{
		...
		if(%ex.impulseForce >= 1000 || %ex.radiusDamage >= 100)
			schedule(500,0,playRangedSound,%obj,"FarExplodeFireSound",10,2000);
	...
	{
		schedule(500,0,playRangedSound,%obj,"FarSniperFire2Sound",300,2000);
		parent::AIAWMFire(%this,%obj,%slot,%val);
	}
	function G18FAOFire(%this,%obj,%slot,%val)
	{
		schedule(500,0,playRangedSound,%obj,"FarPistolFireSound",200,800);
		parent::G18FAOFire(%this,%obj,%slot,%val);
	}
	function HKL86Fire(%this,%obj,%slot,%val)
	{
		schedule(500,0,playRangedSound,%obj,"FarLMGFireSound",200,1400);
		parent::HKL86Fire(%this,%obj,%slot,%val);
	}
	function M4ComFire(%this,%obj,%slot,%val)
	{
		schedule(500,0,playRangedSound,%obj,"FarAssaultFireSound",200,1200);
	...
	{
		schedule(500,0,playRangedSound,%obj,"FarAssaultFire2Sound",200,1200);
	...
	{
		schedule(500,0,playRangedSound,%obj,"FarSniperFireSound",300,2000);
		parent::JNG90Fire(%this,%obj,%slot,%val);
	}
	function Moss500Fire(%this,%obj,%slot,%val)
	{
		schedule(500,0,playRangedSound,%obj,"FarShotgunFireSound",200,1200);
		parent::Moss500Fire(%this,%obj,%slot,%val);
	}
	function HKMP5KFire(%this,%obj,%slot,%val)
	{
		schedule(500,0,playRangedSound,%obj,"FarSMGFireSound",200,800);
